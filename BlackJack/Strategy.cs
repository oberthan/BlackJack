...
public class Strategy
{
    ...
    public Move Decide(Player player, CardValue dealerUp, bool afterSplit)
    {
        ...
        if (isSoft)
        {
            ...
            if (cards.Count == 4 && total == 18 && (upValue is >= 8 and <= 11)) return Move.Hit;
        ...
        if (!isSoft)
        {
            ...
            // six card charlie strats
            if (cards.Count == 5 && total == 12 && upValue is >= 4 and <= 6) return Move.Hit;
            if (cards.Count == 5 && total == 13 && (upValue == 2 || upValue == 3)) return Move.Hit;
