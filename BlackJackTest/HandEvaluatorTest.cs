...
namespace BlackJackTest
{
    ...
    public class HandEvaluatorTest
    {
        ...
        {
            var hand = new List<CardValue> { Ace, King };
        ...
        {
            var hand = new List<CardValue> { Ace, Ten };
        ...
        {
            var hand = new List<CardValue> { Ace, Five, Five };
            var eval = HandEvaluator.Instance.Evaluate(hand, treatTwoCard21AsBlackjack: true);
        ...
        {
            var hand = new List<CardValue> { Ace, Nine };
            var eval = HandEvaluator.Instance.Evaluate(hand, treatTwoCard21AsBlackjack: false);
        ...
        {
            var hand = new List<CardValue> { Ten, Nine, Two };
            var eval = HandEvaluator.Instance.Evaluate(hand, treatTwoCard21AsBlackjack: false);
        ...
        {
            var hand = new List<CardValue> { Ten, Ten, Five };
            var eval = HandEvaluator.Instance.Evaluate(hand, treatTwoCard21AsBlackjack: false);
        ...
        {
            var hand = new List<CardValue> { Ace, Ace, Nine };
            var eval = HandEvaluator.Instance.Evaluate(hand, treatTwoCard21AsBlackjack: false);
        ...
        public void Evaluate_MultipleAces_BustIfTooMany()
        {
            ...
            var hand = new List<CardValue> { Ace, Ace, Ten, Nine };
            var eval = HandEvaluator.Instance.Evaluate(hand, treatTwoCard21AsBlackjack: false);
